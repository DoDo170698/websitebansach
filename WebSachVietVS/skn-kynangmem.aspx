<%@ Page Title="" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true" CodeBehind="skn-kynangmem.aspx.cs" Inherits="WebSachVietVS.kynangmem" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_head" runat="server">
    <title>Kỹ Năng Mềm - Sách Kỹ Năng</title>
    <link href="CSS/theloaii.css" rel="stylesheet" />
    <style>
        #sachkynang{
            background-color: #289928;
        }
        .content-list-theloai .kynangmem{
