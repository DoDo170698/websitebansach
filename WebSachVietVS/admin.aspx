<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin.aspx.cs" Inherits="WebSachVietVS.admin" %>
                ...
                <div class="chucnang-taikhoan">
                    <ul>
                        ...
                        <li>
                            ...
                            <asp:Button  ID="btncapquyen" runat="server" Text="Cấp quyền" class="btntaikhoan" OnClick="btncapquyen_Click"></asp:Button>
                            ...
                            <asp:Button  ID="btncc" runat="server" Text="cc" class="btntaikhoan"></asp:Button>
                        </li>
                        <li>
