<%@ Page Title="" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true" CodeBehind="sachkynang.aspx.cs" Inherits="WebSachVietVS.sachkynang1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_head" runat="server">
    <title>Sách Kỹ Năng - Đô Đô Sách</title>
	...
	<div class="theloai-right">
		<div class="contenter-danhmuc" id="content-kynangcoban">
			<div class="title-box">
				...
				<a class="readmore" href="skn-kynangcoban.aspx">Xem tất cả >></a>
			</div>
		...
		<div class="contenter-danhmuc" id="content-kynangmem">
			<div class="title-box"s>
				<img src="hinhanh/icon-sach.jpg">
				<a><b>Kỹ năng mềm</b></a>
				<a class="readmore" href="skn-kynangmem.aspx">Xem tất cả >></a>
			</div>
			<div class="content-box">
				<div class="list-book">
					<ul>
        ...
        <div class="contenter-danhmuc" id="content-kynangcuocsong">
			<div class="title-box"s>
				<img src="hinhanh/icon-sach.jpg">
				<a><b>Kỹ năng cuộc sống</b></a>
				<a class="readmore" href="skn-kynangcuocsong.aspx">Xem tất cả >></a>
			</div>
			<div class="content-box">
				<div class="list-book">
					<ul>
