<%@ Page Title="" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true" CodeBehind="truyendoc.aspx.cs" Inherits="WebSachVietVS.truyendoc" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_head" runat="server">
    <title>Truyện Đọc - Đô Đô Sách</title>
		...
		<div class="theloai-right">
			<div class="contenter-danhmuc" id="content-giaotrinh">
				<div class="title-box">
					...
					<a href="#"><b>Tiểu thuyết</b></a>
					<a class="readmore" href="trd-tietthuyet.aspx">Xem tất cả >></a>
				</div>
			...
			<div class="contenter-danhmuc" id="content-danhmuc">
				<div class="title-box"s>
					<img src="hinhanh/icon-sach.jpg">
					<a href="#"><b>Cổ tích</b></a>
					<a class="readmore" href="trd-cotich.aspx">Xem tất cả >></a>
				</div>
				<div class="content-box">
					<div class="list-book">
						<ul>
            ...
            <div class="contenter-danhmuc" id="content-thamkhao">
				<div class="title-box"s>
					...
					<a class="readmore" href="trd-ngontinh.aspx">Xem tất cả >></a>
				</div>
				<div class="content-box">
					<div class="list-book">
						<ul>
            ...
            <div class="contenter-danhmuc" id="content-thamkhao">
				<div class="title-box"s>
					<img src="hinhanh/icon-sach.jpg">
					<a href="#"><b>Trinh thám</b></a>
					<a class="readmore" href="trd-trinhtham.aspx">Xem tất cả >></a>
				</div>
				<div class="content-box">
					<div class="list-book">
						<ul>
