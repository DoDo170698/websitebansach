<%@ Page Title="" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true" CodeBehind="trd-tieuthuyet.aspx.cs" Inherits="WebSachVietVS.td_tieuthuyet" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_head" runat="server">
    <title>Tiểu Thuyết - Truyện Đọc</title>
    <link href="CSS/theloaii.css" rel="stylesheet" />
    <style>
        #truyendoc{
            background-color: #289928;
        }
        .content-list-theloai .tieuthuyet{
